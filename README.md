...
- Cross-platform, written with MAUI (`Profitocracy`);
- Cross-platform, created with React Native (`profitocracy-mobile`);
- Android, written with Java (`profitocracy-ios`);
- iOS, created with Swift (`profitocracy-android`).
